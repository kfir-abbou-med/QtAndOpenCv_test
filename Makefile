#############################################################################
# Makefile for building: QtOpenCVApp
# Generated by qmake (3.1) (Qt 5.15.3)
# Project:  QtOpenCVApp.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile QtOpenCVApp.pro
#############################################################################
...
INCPATH       = -I. -I/usr/include/opencv4 -I/usr/include/aarch64-linux-gnu/qt5 -I/usr/include/aarch64-linux-gnu/qt5/QtWidgets -I/usr/include/aarch64-linux-gnu/qt5/QtGui -I/usr/include/aarch64-linux-gnu/qt5/QtCore -I. -I/usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QtOpenCVApp1.0.0
DISTDIR = /home/kfir/git/QtOpenCVApp/.tmp/QtOpenCVApp1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio /usr/lib/aarch64-linux-gnu/libQt5Widgets.so /usr/lib/aarch64-linux-gnu/libQt5Gui.so /usr/lib/aarch64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: QtOpenCVApp.pro /usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/lex.prf \
		QtOpenCVApp.pro
	$(QMAKE) -o Makefile QtOpenCVApp.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents CameraWindow.h CameraWorker.h MainWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp CameraWindow.cpp CameraWorker.cpp MainWindow.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_CameraWindow.cpp moc_CameraWorker.cpp moc_MainWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_CameraWindow.cpp moc_CameraWorker.cpp moc_MainWindow.cpp
...
moc_CameraWorker.cpp: CameraWorker.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/kfir/git/QtOpenCVApp/moc_predefs.h -I/usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/kfir/git/QtOpenCVApp -I/usr/include/opencv4 -I/usr/include/aarch64-linux-gnu/qt5 -I/usr/include/aarch64-linux-gnu/qt5/QtWidgets -I/usr/include/aarch64-linux-gnu/qt5/QtGui -I/usr/include/aarch64-linux-gnu/qt5/QtCore -I/usr/include/c++/11 -I/usr/include/aarch64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/aarch64-linux-gnu/11/include -I/usr/local/include -I/usr/include/aarch64-linux-gnu -I/usr/include CameraWorker.h -o moc_CameraWorker.cpp
...
CameraWorker.o: CameraWorker.cpp CameraWorker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o CameraWorker.o CameraWorker.cpp
